        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('administrator.updateCourse') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-center justify-end">
                            ...
                            <a href="{{ route('administrator.showCourses') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded ml-4">{{ __('Cancelar') }}</a>
                        </div>                        
                    </form>
                </div>
            </div>
